...
public class JavaAPIService {
	...
	public void method1() {
		...
		Integer wrap1 = num1; // 컴파일러 Auto Boxing 수행 코드 추가
	...
	//String 이어쓰기를 이용한 방법
	// -> 코드를 짧으나 효율이 좋지 않음(속도, 메모리 소모 up)
	...
	/**
	 * String의 불변성(immutable, 변하지 않는 겅질 == 상수)
	...
	public void method3() {
		...
		// -> 같은 객체에 저장된 닶이 변했다면 주소는 일정해야 된다!
	 ...
	 *  - "" 리터럴러 생성된 String -> JVM 관리 (String Pool)
	...
	/**
	 * StringBuilder / String Buffer 클래스
	 ...
	 *    -> 마음대로 문자열 수정, 삭제 가능!
	 *    -> 수정, 삭제를 햐도 추가적인 객체 생성이 없어 효율  좋음!
	 *    
	...
	public void method6() {
		...
		sb.append("무었을 먹을까요?"); // 오늘 점심은 무었을 먹을까요?
		System.out.println(System.identityHashCode(sb));
		...
		// - 문자열을 "구붅자" 를 기준으로 쪼개어 String[]로 반환

 ...
 *    
 *  2) 순서 유지 X (단, LinkedHashedMap 제외)
 *  
 *  *  Key만 묶어서 모면 Set과 같은 특징을 지니고 있음!
 ...
 */
	...
	public void method1() {
		...
		System.out.println(map.put(3,"스파이시쉬림프")); // 3 2
		
		System.out.println(map);
		
		//2. V get(K k) : K 에 해당되는 Value 반환
	...
	public void method2() {
		...
		//Set<K> Map.keySet() : 
		//Map 에 Key 만 뽑아내서 Set형태로 만들어 반환
	...
	/**
	 *  Map 활용 하기 - DTO 대체하기
	 *   - 서로 다른 데이터를 한 번에 묶어서 관라해야 하는 경우 
	 */
	public void method4() {

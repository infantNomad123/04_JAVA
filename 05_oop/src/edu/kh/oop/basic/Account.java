...
public class Account {
	...
	// - 속성에 직접 접근을 할 수 없으므로
	// 대신 간접 접근을 할수 있는 기능을 작성해야 함
	
	//속성(값)
	
	private String name;				  		    //이름(예금주)
	private String accountNumber;         //개좌 번호
	...
	//accountNumber 값 게팅하는 간접 접근 기능
	public void setAccountNumber(String accountNumber) {
		this.accountNumber = accountNumber;
	}
	
	//accountNumber 값을 반환하는 기능을 이요해서 객체의 속성을 
	//accountNumber 값 게팅하는 간접 접근 기능

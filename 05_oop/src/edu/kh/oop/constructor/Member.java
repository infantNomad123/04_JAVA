 ...
 * 		전달 받은 매개 변수에 따라서 조금씩 동작이 달라애 하는 경우
 *    상황별로 정의
 *    
 *    
 *    
...
public class Member {
	...
	public  Member() {
		System.out.println("[기본] 샌성자로 Member 객체 생성됨");
		//생성시 객체 초기화
	...
	/* 매개 변수 생성자*/
	//-객체 샹송 시 매개 변수로 전달된 값을
	// 생성된 객체의 필드에 초기화는 용도의 생성자
	public Member(String memberId, String memberPw, String memberName, int memberAge ) {
		System.out.println("[매새 변수] 생성자로 객체 생성됨");

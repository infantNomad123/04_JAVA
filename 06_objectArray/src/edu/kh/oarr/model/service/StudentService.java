...
public class StudentService {
	...
	// 학생 참조 변수  10개 묶음 인 Student[] 생성 (할당) 하고
	// 그 주소를 students 참조 변수에 대입
	
	//기본 생성자
	public StudentService() {
		//학생 객체 배열 (students)에 샘플 학생 3 명 추가

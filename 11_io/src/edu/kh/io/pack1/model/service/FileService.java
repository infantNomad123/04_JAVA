...
public class FileService {
	...
	public void method1() {
		...
		//C:/io_test/20240215 폴더를 지정
		File directory = new File("/io_test/20240215");
		// -> 처음 : 존재하지 않는 폴더를 관리하는 File 갹채 생성
		...
		if(!directory.exists()) { //폴더가 존재하지 않으면
			...
			System.out.println(directory.getName()); //20240215
			System.out.println(directory.getPath()); // \io_test\20240215
		}
	}
...
//		 System.out.println(lastModified);
		 ...
		 // 메개 변수 long 값을 지정된 패턴 형식으로 변화하여
		 // 문자열 형태로 반환
...
//		 System.out.println(date);
		 ...
		 String result = String.format("%-30s %-20s %-10s %10s", fileName, date, type, size);

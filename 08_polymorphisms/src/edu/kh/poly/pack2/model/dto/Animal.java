...
// - 추상 메서드를 포함하고 있는 클래스
// - 미완성인 부분을 포함하고 있기 때문에 객체롤 생성하는 것이 불가능!
...
//getter/setter
	...
	// 모든 동물이 먹고, 자는데....
	//그 방법들이 너무 각양각색 -> 하나도 정의 내리기 어려움
	// -> 부모 클래스 Animal 에서  eat(), sleep() 을 정의 할 수 없음
  //	 -> Animal 을 상속 받는 자식 클래스에서 

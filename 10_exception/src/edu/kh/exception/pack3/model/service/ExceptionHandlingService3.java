 ...
 */
	...
	public void method2() {
		...
		//br.readLine(0 : 입력된 한 줄 읽어오기 (엔터 까지 읽어오기)
		/*public String readLine()throws IOException*/
		// -> IOException 에외 처리 구문이 필수적으로 작성 되어야 함!!
		try { // readLine() 때문에 작성한 예외 처리 구문!!!
			String input = br.readLine();
			
			System.out.println("입력 받은 문자열 : " + input);
		}catch(IOException e){
			System.out.println("예외 잠아서 처리함");
		}
	...
	public void method3() {
		...
		//BufferedReader 를 이용해서 입력 받기
		
		BufferedReader br = new BufferedReader(new InputStreamReader(System.in));
		String input = null; // null은 참조형 변수의 가본 값
		try {
...
//		-> 예외 처리 코드 (try-catch, throws)  작성 
	...
	public String inputString() throws IOException{
		...
		//throws IOException:
		// 현재 메서드에서 발생할 수 있는 (던져질 수 있는) IOException 을
		// 현재 메서드를 호출한 곳으로 던져서
		// 상황에 맞게 별도로 처리하게 함
...
//				 throw new MoreThanAHundredException();
				 throw new MoreThanAHundredException("100 을 초과하다니....");
			 }
			 System.out.println(result); // 결과 출력
			 
		 }catch(IOException e) {
			 System.out.println("IOException 발생 처리");
		 }catch(NumberFormatException e) {
...
//				at edu.kh.exception.pack3.model.service.ExceptionHandlingService3.method5(ExceptionHandlingService3.java:193)

...
public class PrintEx1 {
	...
	public static void main(String[] args) {
		 ...
		 *  음수(-) : 왼쪽 정렬 
		 *  
		 *  %숫자d : 숫자가 출력된 칸을 숫자 만큼 확보
		 *  
		 *  ex) %-6d : 10___________
		 *  ex) %6d  : ___________10
		 *  
		 *  %.숫자f : 소수점 아리 몇째 자리 까지 표시할지 지정 
		 *  					(지정된 자리 아래에서 반올림 처리)
		 *  
		 *  두 번째 매개 변수
		...
		//홍길동은 30대 남성으로 키는 178.4cm 이고, 자바 공부 여부 :true
		System.out.printf("%s은 %d세 %c성으로 키는 %.1fcm 이고, 자바 공부 여부 : %b", name, age, gender, height, javaStudy);

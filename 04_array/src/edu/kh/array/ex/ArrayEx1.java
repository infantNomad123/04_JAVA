...
public class ArrayEx1 {
	...
	public void method1() {
		...
		//변수 선언
		int num ;
		//Stack 영역에 int 자료형을 저장할수 있는 변수를 생성하고
		//  그변수의 이름을 "num"으로 지정
		...
		//배열 선언
		int[] arr;
		//Stack 영역에 int[] 자료형을 참조할  저장할 변수를 생성하고 (주소 저장)
		//그변수의 이름을 "arr"으로 지정
		...
		/*[이클립스 디버그 모드 사용 방법]
		 * 
		 * 1) 확인 하고 싶은 코드 다음 줄애 break point 추가
		 * 
	...
	public void method2() {
		...
		for(int i =0; i < arr.length; i++) {
			...
			arr[i] = sc.nextInt(); // i번째 인데스 요소에 입력 값을 대입
	...
	public void method3() {
		...
		//subjects 변수가 참조하는 배열애 있는 모든 요소의 값을
		//역순으로 출력
